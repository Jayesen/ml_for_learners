...
Medu = st.selectbox('Mothers education (1 is lowest level of education)', (1,2,3,4))
reason = st.selectbox('Reason for choosing school:', ('reputation','course','home', 'other'))
traveltime = st.selectbox('Travel time to school (1: under 15mins, 2: 15-30mins, 3: 30-60mins, 4: More than 60mins):', (1, 2, 3, 4))
studytime = st.selectbox('Weekly study time (1: less than 2 hours, 2: 2-5 hours, 3: 5-10 hours, 4: Greater than 10 hours):', (1, 2, 3, 4))
freetime = st.selectbox('Weekly free time (1: very low, 5: very high):', (1, 2, 3, 4, 5))
